...
#top {
  ...
  <div class="menu">
      <ul>
        ...
        <li><a href="statistics.php?curr=<?php echo $_GET['curr']; ?>"><span>Account Statistics</span></a></li>
        <li><a href="statistics1.php?curr=<?php echo $_GET['curr']; ?>"><span>Profit Statistics</span></a></li>
